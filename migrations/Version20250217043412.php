 ...
 */
final class Version20250217043412 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE evenment ADD horaire_debut DATETIME NOT NULL, ADD horaire_fin DATETIME NOT NULL, ADD places_disponibles INT NOT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE evenment DROP horaire_debut, DROP horaire_fin, DROP places_disponibles');
